...
import 'package:wellnesstrackerapp/features/app_manager/view/app_manager_view.dart'
    as _i12;
import 'package:wellnesstrackerapp/features/auth/cubit/auth_cubit.dart' as _i71;
...
import 'package:wellnesstrackerapp/features/users/model/user_model/user_model.dart'
    as _i70;
import 'package:wellnesstrackerapp/features/users/view/users_view.dart' as _i46;
import 'package:wellnesstrackerapp/global/models/user_role_enum.dart' as _i66;
...
class AddAdvRoute extends _i48.PageRouteInfo<AddAdvRouteArgs> {
  AddAdvRoute({
    _i49.Key? key,
    required _i50.AddsAndOffersCubit advCubit,
    _i51.AdvModel? adv,
...
class AddAdvRouteArgs {
  ...
  final _i50.AddsAndOffersCubit advCubit;

  final _i51.AdvModel? adv;
...
class AddExercisePlanRoute
  ...
  AddExercisePlanRoute({
    _i49.Key? key,
    required _i52.ExercisePlansCubit exercisePlansCubit,
    _i53.ExercisePlanModel? exercisePlan,
    List<_i48.PageRouteInfo>? children,
  }) : super(
...
class AddExercisePlanRouteArgs {
  ...
  final _i52.ExercisePlansCubit exercisePlansCubit;

  final _i53.ExercisePlanModel? exercisePlan;
...
class AddExerciseRoute extends _i48.PageRouteInfo<AddExerciseRouteArgs> {
  AddExerciseRoute({
    _i49.Key? key,
    required _i54.ExercisesCubit exercisesCubit,
    _i55.ExerciseModel? exercise,
    List<_i48.PageRouteInfo>? children,
  }) : super(
...
class AddExerciseRouteArgs {
  ...
  final _i54.ExercisesCubit exercisesCubit;

  final _i55.ExerciseModel? exercise;
...
class AddItemRoute extends _i48.PageRouteInfo<AddItemRouteArgs> {
  AddItemRoute({
    _i49.Key? key,
    required _i56.ItemsCubit itemCubit,
    _i57.ItemModel? item,
    _i49.VoidCallback? onSuccess,
    _i58.LevelModel? level,
    List<_i48.PageRouteInfo>? children,
  }) : super(
         AddItemRoute.name,
...
class AddItemRouteArgs {
  ...
  final _i56.ItemsCubit itemCubit;

  final _i57.ItemModel? item;

  final _i49.VoidCallback? onSuccess;

  final _i58.LevelModel? level;
...
class AddLevelRoute extends _i48.PageRouteInfo<AddLevelRouteArgs> {
  AddLevelRoute({
    _i49.Key? key,
    required _i59.LevelsCubit levelsCubit,
    _i49.VoidCallback? onSuccess,
    _i58.LevelModel? level,
    List<_i48.PageRouteInfo>? children,
  }) : super(
...
class AddLevelRouteArgs {
  ...
  final _i59.LevelsCubit levelsCubit;
...
class AddMealPlanRoute extends _i48.PageRouteInfo<AddMealPlanRouteArgs> {
  AddMealPlanRoute({
    _i49.Key? key,
    required _i60.MealPlansCubit mealPlansCubit,
    _i61.MealPlanModel? mealPlan,
    List<_i48.PageRouteInfo>? children,
  }) : super(
...
class AddMealPlanRouteArgs {
  ...
  final _i60.MealPlansCubit mealPlansCubit;

  final _i61.MealPlanModel? mealPlan;
...
class AddMealRoute extends _i48.PageRouteInfo<AddMealRouteArgs> {
  AddMealRoute({
    _i49.Key? key,
    required _i62.MealsCubit mealsCubit,
    _i63.MealModel? meal,
    List<_i48.PageRouteInfo>? children,
  }) : super(
         AddMealRoute.name,
...
class AddMealRouteArgs {
  ...
  final _i62.MealsCubit mealsCubit;

  final _i63.MealModel? meal;
...
class AddPointsGuidelineRoute
  ...
  AddPointsGuidelineRoute({
    _i49.Key? key,
    required _i64.PointsCubit pointsCubit,
    _i65.PointsGuidelineModel? guideline,
    _i49.VoidCallback? onSuccess,
    List<_i48.PageRouteInfo>? children,
  }) : super(
...
class AddPointsGuidelineRouteArgs {
  ...
  final _i64.PointsCubit pointsCubit;

  final _i65.PointsGuidelineModel? guideline;
...
class AddsAndOffersRoute extends _i48.PageRouteInfo<AddsAndOffersRouteArgs> {
  AddsAndOffersRoute({
    _i49.Key? key,
    required _i66.UserRoleEnum role,
    List<_i48.PageRouteInfo>? children,
  }) : super(
...
class AppManagerRoute extends _i48.PageRouteInfo<AppManagerRouteArgs> {
  AppManagerRoute({
    _i49.Key? key,
    required _i67.SignInModel user,
    List<_i48.PageRouteInfo>? children,
  }) : super(
...
class ApproveCustomerRoute
  ...
  ApproveCustomerRoute({
    _i49.Key? key,
    required _i68.CustomerModel customer,
    required _i69.CustomersCubit customersCubit,
    _i49.VoidCallback? onSuccess,
    List<_i48.PageRouteInfo>? children,
  }) : super(
...
class ApproveCustomerRouteArgs {
  ...
  final _i68.CustomerModel customer;

  final _i69.CustomersCubit customersCubit;
...
class MealsRoute extends _i48.PageRouteInfo<MealsRouteArgs> {
  ...
  static _i48.PageInfo page = _i48.PageInfo(
    ...
    builder: (data) {
      ...
      return MealsView(key: args.key, role: args.role);
    },
  );
}
...
class SelectPlanRoute extends _i48.PageRouteInfo<void> {
  ...
  static _i48.PageInfo page = _i48.PageInfo(
    name,
    builder: (data) {
      return const _i38.SelectPlanView();
    },
  );
}
...
class SettingsRoute extends _i48.PageRouteInfo<SettingsRouteArgs> {
  ...
  static _i48.PageInfo page = _i48.PageInfo(
    ...
    builder: (data) {
      ...
      return _i39.SettingsView(key: args.key, role: args.role);
    },
  );
}
...
class SignInRoute extends _i48.PageRouteInfo<SignInRouteArgs> {
  ...
  static _i48.PageInfo page = _i48.PageInfo(
    ...
    builder: (data) {
      ...
      return _i40.SignInView(key: args.key, onSignedIn: args.onSignedIn);
    },
  );
}
...
class StatisticsRoute extends _i48.PageRouteInfo<void> {
  ...
  static _i48.PageInfo page = _i48.PageInfo(
    name,
    builder: (data) {
      return const _i42.StatisticsView();
    },
  );
}

/// generated route for
/// [_i43.TermsAndConditionsView]
class TermsAndConditionsRoute extends _i48.PageRouteInfo<void> {
  ...
  static _i48.PageInfo page = _i48.PageInfo(
    name,
    builder: (data) {
      return const _i43.TermsAndConditionsView();
    },
  );
}

/// generated route for
/// [_i44.UpdateCustomerInfoView]
class UpdateCustomerInfoRoute
  ...
  static _i48.PageInfo page = _i48.PageInfo(
    ...
    builder: (data) {
      ...
      return _i44.UpdateCustomerInfoView(
        key: args.key,
        customersCubit: args.customersCubit,
        customer: args.customer,
        role: args.role,
...
class UserNavigationRoute extends _i48.PageRouteInfo<void> {
  ...
  static _i48.PageInfo page = _i48.PageInfo(
    name,
    builder: (data) {
      return const _i45.UserNavigationView();
    },
  );
}
...
class UsersRoute extends _i48.PageRouteInfo<void> {
  ...
  static _i48.PageInfo page = _i48.PageInfo(
    name,
    builder: (data) {
      return const _i46.UsersView();
    },
  );
}

/// generated route for
/// [_i47.VerifyResetCodeView]
class VerifyResetCodeRoute
    extends _i48.PageRouteInfo<VerifyResetCodeRouteArgs> {
  VerifyResetCodeRoute({
    _i49.Key? key,
    required _i71.AuthCubit authCubit,
    List<_i48.PageRouteInfo>? children,
  }) : super(
  ...
  static _i48.PageInfo page = _i48.PageInfo(
    ...
    builder: (data) {
      ...
      return _i47.VerifyResetCodeView(key: args.key, authCubit: args.authCubit);
    },
  );
}
...
class VerifyResetCodeRouteArgs {
  ...
  final _i71.AuthCubit authCubit;
